...
// Hero section image link
const HERO_IMAGE = '/gallery/gallery-2.jpg';
...
/* ── Stored/Downloaded Gallery Data ── */
...
function GalleryContent() {
  return (
    <div className="min-h-screen font-sans text-slate-900 overflow-x-hidden bg-slate-50">
      ...
      {/* Removed the unused restaurants prop from Navbar to fix any potential type errors */}
      <Navbar />
      <CartDrawer />
      ...
      <div className="relative z-10 pt-24 md:pt-32">
        ...
        <section className="container mx-auto px-6 md:px-12 max-w-[1200px] mb-12">
          <div className="bg-blue-950 rounded-[2rem] overflow-hidden relative shadow-2xl flex items-center min-h-[250px] md:min-h-[350px] px-8 md:px-16 py-12 text-center">
            ...
            {/* Added relative here so the image fills this container, not the whole screen */}
            <div className="absolute inset-0 z-0 opacity-20 relative w-full h-full">
              <Image 
                src={HERO_IMAGE} 
            ...
            <div className="absolute inset-0 z-10 max-w-3xl mx-auto flex flex-col items-center justify-center pointer-events-none">
              <FadeUp>
                ...
                <p className="text-blue-200 text-lg font-light leading-relaxed max-w-xl mx-auto drop-shadow-sm px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              {extendedGallery.map((src, index) => (
                <FadeUp key={index} delay={index * 50}>
                  {/* Container has relative, so fill works correctly */}
          ...
          <div className="container mx-auto px-6 max-w-[1200px]">
            <div className="flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-8">
              <div className="flex items-center gap-3 shrink-0">
                <Image src="/logo.jpeg" alt="Tahera Logo" width={40} height={40} className="rounded-full shadow-sm object-contain w-auto h-auto" />
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 lg:gap-10">
                ...
                <div className="flex items-center">
                  <a href="mailto:salmanntechs@gmail.com" className="text-sm text-slate-600 hover:text-red-600 transition-colors font-medium">salmanntechs@gmail.com</a>
                </div>
